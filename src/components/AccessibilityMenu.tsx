        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-3 left-3 bottom-[9rem] z-[62] mx-auto w-[min(18rem,calc(100vw-1.5rem))] max-h-[min(70dvh,calc(100dvh-12rem))] overflow-y-auto overscroll-contain rounded-2xl border border-border bg-card p-4 shadow-xl"
            >
